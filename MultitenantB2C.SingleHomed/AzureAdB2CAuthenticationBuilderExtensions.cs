    ...
    public static class AzureAdB2CAuthenticationBuilderExtensions
    {
        ...
        public class OpenIdConnectOptionsSetup : IConfigureNamedOptions<OpenIdConnectOptions>
        {
            ...
            public Task OnRedirectToIdentityProvider(RedirectContext context)
            {
                ...
                {
                    context.ProtocolMessage.LoginHint = context.Properties.GetParameter<string>("login_hint");
                }
                if (context.Properties.Parameters.ContainsKey("domain_hint"))
                {
                    context.ProtocolMessage.DomainHint = context.Properties.GetParameter<string>("domain_hint");
                }
